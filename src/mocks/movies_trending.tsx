  ...
  movies: [
    {
      ...
      category: 'Ficção',
      trailerLink: 'https://www.youtube.com/embed/Nq5wKa0ihmM',
      year: 2011,
      director: 'Steven Spielberg',
      imageLink:
        'http://1.bp.blogspot.com/-ZCXb9XicB6I/Txf5cU6w-iI/AAAAAAAAAxk/aEHQfqy3Pvw/s1600/Tintim.jpg'
    },
    {
      id: 60,
      title: 'Bacurau',
      ...
      trailerLink: 'https://www.youtube.com/embed/qlheaoLnewE',
      year: 2019,
    ...
    },
    {
      ...
      category: 'Ficção',
      trailerLink: 'https://www.youtube.com/embed/8YjFbMbfXaQ',
      year: 2021,
    ...
    {
      id: 62,
      title: 'Space Jam, o jogo do Seculo',
      description: 'Aquele lá dos coelhos que jogam basquete',
      category: 'Ficção',
      trailerLink: 'https://www.youtube.com/embed/oKNy-MWjkcU',
      year: 1996,
      director: 'Joe Pytka',
      imageLink:
    ...
    },
    {
      ...
      category: 'Ficção',
      trailerLink: 'https://www.youtube.com/embed/w1dIkYegWuQ',
      year: 2014,
    ...
    },
    {
      ...
      category: 'Ficção',
      trailerLink: 'https://www.youtube.com/embed/v8ItGrI-Ou0',
      year: 2007,
    ...
    },
    {
      ...
      category: 'Ficção',
      trailerLink: 'https://www.youtube.com/embed/MSs0gZJ5P9o',
      year: 2001,
    ...
    },
    {
      ...
      description: 'The boy who leaves under the tails',
      category: 'Ficção',
      trailerLink: 'https://www.youtube.com/embed/1bq0qff4iF8',
      year: 2002,
      director: 'Chris Columbus',
      imageLink:
    ...
    },
    {
      ...
      description: 'The boy who leaves under the tails',
      category: 'Ficção',
      trailerLink: 'https://www.youtube.com/embed/Tbv2Al6LGW8',
      year: 2007,
    ...
    },
    {
      ...
      description: 'The boy who leaves under the tails',
      category: 'Ficção',
      trailerLink: 'https://www.youtube.com/embed/RwJlOdtoHRE',
      year: 2005,
    ...
    },
    {
      ...
      description: 'The boy who leaves under the tails',
      category: 'Ficção',
      trailerLink: 'https://www.youtube.com/embed/kSEc4_MR3xs',
      year: 2009,
      director: 'David Yates',
      imageLink:
    ...
    },
    {
      ...
      category: 'Ficção',
      trailerLink: 'https://www.youtube.com/embed/hA6hldpSTF8',
      year: 2012,
    ...
    },
    {
      ...
      category: 'Ficção',
      trailerLink: 'https://www.youtube.com/embed/6bpZXJgtYww',
      year: 2019,
      director: 'Jon Watts',
      imageLink:
    ...
    },
    {
      ...
      category: 'Ficção',
      trailerLink: 'https://www.youtube.com/embed/a-PVBsmiB0Y',
      year: 2008,
